...
factors_sn <- c(NA, 0.7430, 1.8498, 0.9551, 1.3486, 0.9941, 1.1983, 1.0050, 1.1318, 1.0069, 
...
factors_qn <- c(NA, 0.3995, 0.9939, 0.5133, 0.8441, 0.6122, 0.8589, 0.6700, 0.8736, 0.7201, 
...
#' \itemize{
#'   \item For small samples (n < 50), a high-speed O(n^2) scalar engine is used.
#'   \item For larger samples, a multi-threaded O(n log n) algorithm via RcppParallel is used.
#' }
...
#' This implementation uses a fast hybrid architecture:
#' \itemize{
#'   \item For small samples (n < 100), a high-speed O(n^2) scalar engine is used.
#'   \item For larger samples, a multi-threaded O(n log n) implementation using the Johnson-Mizoguchi selection algorithm.
#' }
