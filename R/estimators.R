...
#'   \item For larger samples (n > 10000), a multi-threaded O(n log n) algorithm via RcppParallel is used.
#' }
...
#'   \item For larger samples (n > 3000), a multi-threaded O(n log n) implementation using the Johnson-Mizoguchi selection algorithm.
#' }
