...
#' \itemize{
#'   \item For sample sizes n <= 4096, a high-speed deterministic C++ kernel is used.
#'   \item For larger samples (n > 4096), a multi-threaded algorithm via RcppParallel is used.
