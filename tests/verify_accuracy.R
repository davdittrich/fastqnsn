...
akinshin_sn <- function(x) {
  ...
  predict_factor <- function(n) {
    inv_n <- 1.0 / n
    if (n %% 2 == 1) 1.0 + 0.7096 * inv_n - 7.3604 * inv_n^2
    else 1.0 + 0.0391 * inv_n - 6.1719 * inv_n^2
  }
...
akinshin_qn <- function(x) {
  ...
  predict_factor <- function(n) {
    inv_n <- 1.0 / n
    if (n %% 2 == 1) 1.0 - 1.6022 * inv_n + 4.7453 * inv_n^2
    else 1.0 - 3.6741 * inv_n + 11.1030 * inv_n^2
  }
  factor <- if (n <= 100) factors[n] else predict_factor(n)
